...
6. Реализован SensorSyncAdapter, сервис-адаптер, который будет получает изменения в таблице БД монолита через Kafka и отправлять соответствующие запросы в DeviceService и LocationService. ЯП: Python
